const quotes = [
    ...
    { text: "Mong Công lấy vợ thành công, chúc em bớt mỏ hỗn", author: "for CongPT" },
    ...
    { text: "Mong a Kiên luôn mạnh khỏe, vui vẻ, sớm lấy vợ 👰 và công việc của a luôn luôn thuận lợi", author: "for KienPT " },
    ...
    { text: "Công có hết rồi nên cũng chả biết chúc gì :)) Chúc T1 của Công mãi đỉnh", author: "for CongPT " },
