const quotes = [
    ...
    { text: "Chúc em sớm đạt Ielts 9.0, bắn tiếng anh ầm ầm như người bản xứ 🤩.", author: "for PhucVH" },
    ...
    { text: "Chúc anh Tùng vẽ càng ngày lên tay, trở thành một artist đỉnh của chóp", author: "for TungT " },
