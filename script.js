const quotes = [
    ...
    { text: "Chúc iem nhiều tình thừa tiền, cảm ơn iem vì luôn giúp chị làm mấy cái task vui vui", author: "for ChiNH " },
    { text: "Iem Công có hết rồi nên cũng chả biết chúc gì :)) Chúc T1 của em mãi đỉnk", author: "for CongNT " },
    ...
    { text: "Chúc anh sớm tìm được mục đích đi làm. Chúc anh 6 múi. Chúc anh sớm bắn lỗ nào trúng lỗ nấy 😝", author: "for AnhNT " },
    ...
    { text: "Chúc em có thật nhiều sức khoẻ và niềm vui trong cuộc sống, luôn thành công trong công việc nhé", author: "for SonNHT" },
    { text: "Chúc Đồng có một ngày thật ý nghĩa! ", author: "for DongNS " },
    { text: "Chúc em sẽ luôn đạt được điều mà mình mong muốn 🥳", author: "for NinhNK " },
    ...
    { text: " Mong Minh sẽ có thêm được những người bạn mới cũng như tích lũy được thêm nhiều kiến thức và trải nghiệm đáng quý ^^", author: "for MinhTQ " },
